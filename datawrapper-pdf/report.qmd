...
format:
  ...
  html:
    other-links:
      - text: My Portfolio
        href: https://j3sus.quarto.pub/my-portfolio/posts/python/Mexico_pol_scenario.html
    code-links:
      - text: Code
        icon: file-code
        href: https://github.com/SqlAlchemist/Portfolio/blob/main/Polynomial_regression.ipynb
    page-layout: full
...
![](datawrapper-python.png){width=90% fig-align="center"}
...
filename = Path(__file__).parent.parent/'credentials.json'
# read json file
...
#| echo: true
#| output: false
dw.display_chart('9vB29')
```

::: {#fig-people}

![](people.png){width=100% fig-align="left"}
...
For further information see my teet [Create Stunning Charts with Datawrapper](https://x.com/Sqlalchemist/status/1835830484640919644)
...
![](governors.png){width=90% fig-align="center"}
...
![](cdmx.png){width=90% fig-align="center"}
