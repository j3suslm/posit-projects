...
format:
  ...
  html:
    other-links:
      - text: My Portfolio
        href: https://tinyurl.com/jesuslm-website
    code-fold: show
...
with db.connect(database="presidents.db") as conn:
...     conn.sql(
...         """
...
# database connection
md = os.getenv('MD_TOKEN')
with db.connect(f"md:?motherduck_token={md}") as conn:
  # create dataframe
  df = conn.sql('select * from projects.datawrapper_data').df()
```
