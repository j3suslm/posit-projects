...
![](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVL9tfVWVWLX8jiKGmbm4PhI8VGIqpM0GVxQ&s){.lightbox fig-align="left" width=50%}
...
fig.update_layout(
    ...
    yaxis_range=[0, 12],
    plot_bgcolor='#ececec',
    title=dict(text="Reyna's Weight Evolution", font=dict(size=30, color='#9A607F',), automargin=True, yref='paper'),
    )
...
fig.update_layout(
    ...
    yaxis_range=[0, 12],
    plot_bgcolor='#ececec',
    title=dict(text="Pelusa's Weight Evolution", font=dict(size=30, color='#9A607F',), automargin=True, yref='paper'),
    )
...
fig.update_layout(
    ...
    yaxis_range=[0, 10],
    plot_bgcolor='#ececec',
    title=dict(text="Gunther's Weight Evolution", font=dict(size=30, color='#576E79',), automargin=True, yref='paper'),
    )
...
fig.update_layout(
    ...
    yaxis_range=[0, 5],
    plot_bgcolor='#ececec',
    title=dict(text="Dino's Weight Evolution", font=dict(size=30, color='#576E79',), automargin=True, yref='paper'),
    )
...
fig.update_layout(
    ...
    yaxis_range=[0, 70],
    plot_bgcolor='#ececec',
    title=dict(text="Naty's Weight Evolution", font=dict(size=30, color='#9A607F',), automargin=True, yref='paper'),
    )
...
fig.update_layout(
    ...
    yaxis_range=[0, 90],
    plot_bgcolor='#ececec',
    title=dict(text="Jesus' Weight Evolution", font=dict(size=30, color='#576E79',), automargin=True, yref='paper'),
    )
